@echo off
echo Aubotmation Lab Backend Service 실행 스크립트 (Maven Wrapper 사용)
echo ================================================================
...
java -version
if %errorlevel% neq 0 (
    echo Java가 설치되어 있지 않습니다. Java 17 이상을 설치하세요.
    pause
    exit /b 1
)

echo.
echo 2. Maven Wrapper를 사용하여 프로젝트 빌드 중...
...
echo.
echo 4. Spring Boot 애플리케이션 시작 중...
echo 개발 환경으로 실행됩니다.
